// ==UserScript==
// @name         OP.GG Stats Card (Draggable, Collapsible, Auto Scroll Toggle)
// @namespace    http://tampermonkey.net/
// @version      1.2.0
// @description  Adds a draggable, collapsible stats card to OP.GG summoner pages with toggleable auto-scroll. Tracks playtime, games, laning win rate, and more. Card position and state are session-based for a smooth UX.
// @author       SimronJ
// @match        https://*.op.gg/lol*
// @grant        none
...
(function() {
    ...
    // --- Card position state (session only) ---
    ...
    function updateDisplay(force) {
        ...
        // Collapsible state
        let collapsed = localStorage.getItem('opggCardCollapsed') === 'true';
        ...
        header.querySelector('#collapse-btn').onclick = function(e) {
            ...
            localStorage.setItem('opggCardCollapsed', collapsed);
        };

        // Drag logic (no localStorage)
